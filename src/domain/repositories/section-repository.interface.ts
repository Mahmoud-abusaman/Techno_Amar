...
export type UpdateSectionData = Partial<Omit<CreateSectionData, 'department_id'>> & {
  is_active?: boolean;
};

export interface ISectionRepository {
  create(data: CreateSectionData): Promise<SectionEntity>;
  findAll(departmentId?: bigint, activeOnly?: boolean): Promise<SectionEntity[]>;
  ...
  hasDependents(id: bigint): Promise<boolean>;
}
